...
window.onload=tick;
//隐藏显示查询条件
 function click_a(divDisplay,removeicon)
        { 
            if(document.getElementById(divDisplay).style.display != "block")
            {
               setTimeout( document.getElementById(divDisplay).style.display = "block",1000)
				document.getElementById(removeicon).style.backgroundPosition = "0px -192px";
            }
            else
            {
                document.getElementById(divDisplay).style.display = "none";
				document.getElementById(removeicon).style.backgroundPosition = "0px 0px";
            }
        }
