package cn.com.task.user.controller;
...
import cn.com.task.controller.BaseController;
import cn.com.task.shiro.token.manager.TokenManager;
import cn.com.task.user.service.UUserService;
import cn.com.task.user.service.impl.UserManager;
import cn.com.task.web.utils.VerifyCodeUtils;
...
public class UserLoginController extends BaseController {
	...
	@ResponseBody
	public ModelAndView submitLoginByForm(UUser entity,Boolean rememberMe,HttpServletRequest request){
		String url = null ;
		try {
			if(rememberMe == null){
				rememberMe = false;
